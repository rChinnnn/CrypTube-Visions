				...
				<div className="flex flex-col m-10 mt-5 lg:flex-row">
					<div className="flex lg:w-3/4 flex-col ">
						...
						<textarea
							...
							placeholder="Never Gonna Give You Up was a global smash on its release in July 1987, topping the charts in 25 countries including Rick's native UK and the US Billboard Hot Stock 19. It also won the Brit Award for Best single in 19888888 and Waterman wrote and produced the track which was the lead-off single and lead track from Rick's debut LP “Whenever You Need Somebody."
						...
						<label className="text-[#9CA3AF] mt-10 text-sm">
							Thumbnail
						</label>
