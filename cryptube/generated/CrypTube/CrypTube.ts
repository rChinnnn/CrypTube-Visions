...
export class CrypTube__videosResult {
  value0: BigInt;
  value1: string;
  value2: string;
  value3: string;
...
export class CrypTube extends ethereum.SmartContract {
  static bind(address: Address): CrypTube {
    return new CrypTube("CrypTube", address);
  }
  ...
  videos(param0: BigInt): CrypTube__videosResult {
    ...
    return new CrypTube__videosResult(
      result[0].toBigInt(),
      result[1].toString(),
      result[2].toString(),
      result[3].toString(),
  ...
  try_videos(param0: BigInt): ethereum.CallResult<CrypTube__videosResult> {
